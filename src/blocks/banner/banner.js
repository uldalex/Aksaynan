...
/***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    /* harmony default export */ var components_arrows = (function (Splide, Components, name) {
      ...
      function createArrow(prev) {
        var arrow = "<button class=\"" + classes.arrow + " " + (prev ? classes.prev : classes.next) + "\" type=\"button\">" + ("<svg width='7' height='11' viewBox='0 0 7 11' fill='none' xmlns='http://www.w3.org/2000/svg'><path d='M0.625 1L5.625 5.5L0.625 10' stroke='black'/>       </svg>");
        return domify(arrow);
      }
